 ...
 * [com.claudemani.domain.usecase.GenerateQuizQuestionUseCase] returns
...
sealed interface ReviewUiState {
    ...
    data class Finished(
        ...
        val totalCount: Int,
        /** How many Achievements this session's [com.claudemani.domain.usecase.CheckAndUnlockAchievementsUseCase] call newly unlocked — 0 is the common case. */
