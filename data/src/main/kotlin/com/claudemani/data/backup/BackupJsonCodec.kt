package com.claudemani.data.backup
 ...
 * [com.claudemani.domain.usecase.CreateBackupUseCase]/[com.claudemani.domain.usecase.RestoreBackupUseCase]
...
object BackupJsonCodec {
    ...
    fun decode(text: String): ExportData {
        val dto = try {
            ...
            throw BackupFileFormatException("Not a valid Claudemani backup file", e)
