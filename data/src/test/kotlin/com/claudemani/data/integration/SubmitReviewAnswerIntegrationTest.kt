...
import com.claudemani.domain.exception.DuplicateReviewAttemptException
 ...
 * ([com.claudemani.domain.usecase.SubmitReviewAnswerUseCaseTest] etc.)
 * ran against [com.claudemani.domain.repository.FakeClaudemaniDatabase],
...
class SubmitReviewAnswerIntegrationTest {
     ...
     * atomicity claim: that `ClaudemaniDatabaseImpl.withTransaction`
     * (backed by real `androidx.room.withTransaction`) truly rolls back
     * a write when the block throws afterward — the exact behavior
     * [com.claudemani.domain.repository.FakeClaudemaniDatabase] could
     * never verify.
     */
    @Test
