...
class SelectReviewQueueUseCaseTest {
    ...
    fun `tag filter narrows results`() = runTest {
        ...
        f.conceptTags.insert(com.claudemani.domain.model.ConceptTag(tagged, tagId))
    ...
    fun `filters combine with AND`() = runTest {
        ...
        f.conceptTags.insert(com.claudemani.domain.model.ConceptTag(matches, tagId))
        ...
        f.conceptTags.insert(com.claudemani.domain.model.ConceptTag(wrongDifficulty, tagId))
