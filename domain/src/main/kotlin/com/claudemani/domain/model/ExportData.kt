 ...
 * Backup & Restore" — بخش الف). Populated by [com.claudemani.domain.usecase.CreateBackupUseCase]
 * and consumed by [com.claudemani.domain.usecase.RestoreBackupUseCase]
