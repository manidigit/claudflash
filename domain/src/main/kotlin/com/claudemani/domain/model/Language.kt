 ...
 * means adding one entry here; [com.claudemani.domain.usecase.EnsureDefaultLanguagesUseCase]
 ...
 * (see [com.claudemani.domain.usecase.GetActiveLanguagePairUseCase]).
 * Its id is deterministic and identical to the one
 * [com.claudemani.domain.usecase.EnsureDefaultLanguagePairUseCase] persists.
 */
